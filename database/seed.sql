...
-- Updated for UUID primary keys and new modules (Vendors, Employees, Expenses)

-- Note: UUIDs will be auto-generated by the database
-- Password for all demo accounts (plaintext): admin123 / customer123

-- ============================================
-- INSERT ADMIN USERS
-- ============================================

INSERT INTO users (name, email, password, role, permissions, phone, status) VALUES
('Super Admin', 'admin@devinewater.com', 'admin123', 'SUPER_ADMIN', '["all"]', '+923001234567', 'active'),
('Admin User', 'admin2@devinewater.com', 'admin123', 'ADMIN', '["manage_customers", "manage_billing", "view_reports"]', '+923001234568', 'active'),
('Staff User', 'user@devinewater.com', 'admin123', 'USER', '["view_customers", "view_billing"]', '+923001234569', 'active');
...
INSERT INTO vendors (name, email, phone, address, category, conctact_person, status) VALUES
('AquaPure Supplies', 'sales@aquapure.com', '+923009876543', 'Industrial Area, Karachi', 'Chemicals', 'Mr. Kamran', 'active'),
('TechFlow Systems', 'support@techflow.com', '+923008765432', 'Blue Area, Islamabad', 'Equipment', 'Ms. Sara', 'active');

-- ============================================
-- INSERT SAMPLE EMPLOYEES
-- ============================================

INSERT INTO employees (user_id, cnic, designation, department, joining_date, salary, address)
SELECT 
    id,
    '42201-1234567-9',
...
FROM users
WHERE email = 'user@devinewater.com';
...
INSERT INTO expenses (title, description, amount, category, expense_date, vendor_id, approved_by, status)
SELECT 
    'Monthly Chemical Supply',
    'Chlorine and other purification chemicals',
    25000.00,
    'operational',
    '2024-12-15',
    v.id,
...
WHERE v.email = 'sales@aquapure.com' AND u.email = 'admin@devinewater.com';
